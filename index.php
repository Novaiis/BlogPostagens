...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="index.php">Blog de Notícias</a>
  ...
  <div class="container">
    ...
    <header class="jumbotron my-4">
      ...
      <a href="login.php" class="btn btn-primary btn-lg">Conecte-se</a>
      <a href="register.php" class="btn btn-primary btn-lg">Fazer Postagem</a>
    </header><br><br><br><br><br><br><br><br><br>

    <!-- Page Features -->
    <div><h1>
        <a href="postagens.php">Veja as postagens dos úsuarios</a></h1>
        </div>
    <!-- /.row -->
