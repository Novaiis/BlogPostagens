...
<body>
    ...
    <div class="container">
        ...
        <header class="jumbotron my-4">
            <h3 class="display-3">Informações</h1>
                <p class="lead">Email para contato/duvidas:</p>
                <p class="lead">O blog foi criado desde __ e esta nas redes fazendo jus ao nome, trazendo sempre novas informaçoes da area de TI.</p>
</header>
</div>
    <footer class="rodapi">
        <div class="container">
