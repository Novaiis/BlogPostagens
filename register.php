...
<body class="bg-gradient-primary">
            ...
            <div class="p-5">
              ...
              <form class="user" action="cadastrar.php" method="POST">
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" name="sobrenome" id="exampleLastName" placeholder="Sobrenome">
                  </div>
                </div>
              ...
              <hr>
              <div class="text-center">
                <a class="small" href="login.php">Se ja possuir conta, logue-se</a>
              </div>
              <br>
            </div>
          </div>
  ...
  <script src="css/perso.js"></script>
